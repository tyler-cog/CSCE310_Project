...
<body>
    ...
    <div class="section">
        ...
        <!-- This calls the studentApplications function from the helper php file -->
        <?php
            studentApplication($UIN);
        ?>
        ...
        <form class="Applications" action="ProgramProgress.php" method="POST">
             ...
             <?php
                echo "<td><input type='hidden' name='Application_UINInsert' value='" . $UIN . "'></td>";
            ?>
