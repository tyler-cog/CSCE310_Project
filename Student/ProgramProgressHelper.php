...
<?php
    ...
    //Gets UIN Based on the username from the login page
    ...
    function studentCourseEnrollment($UIN){
        include "../connection.php";
    ...
    function studentCertifications($UIN){
        include "../connection.php";
    ...
    function studentInternships($UIN){
        include "../connection.php";
    ...
    function studentApplication($UIN){
        include "../connection.php";
